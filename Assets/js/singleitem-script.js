...
// Move paragraphs with footnotes (excluding those with "ref")
      ...
      document.addEventListener("DOMContentLoaded", () => {
        document
          .querySelectorAll(
            ".arabica_foot-reference p, .arabica_foot-source li"
          )
          .forEach((el) => {
...
`;
        ...
        function closeAllDropdowns() {
          ...
          allDropdowns.forEach((d) => {
            ...
            if (
              parentIcon &&
              parentIcon.classList.contains("arabica_ref-icon")
            ) {
      ...
      document.addEventListener("DOMContentLoaded", function () {
        ...
        if (videoElement) {
          ...
          if (
            !videoElement.parentElement.classList.contains(
              "arabica_video-container"
            )
          ) {
    ...
    `;
        ...
        const playPauseIndicator =
          document.getElementById("playPauseIndicator");
      ...
      ------------------------------ */
        document
          .querySelectorAll(".arabica_article-image")
          .forEach((container) => {
          ...
          `;
              ...
              const updateSliderHeight = () => {
                const currentSlideElement =
                  sliderWrapper.children[currentSlide];
              ...
              const updateNavButtonsPosition = () => {
                ...
                if (currentSlideElement) {
                  ...
                  if (imgEl) {
                    ...
                    const navCenter =
                      imageRect.top - sliderRect.top + imageHeight / 2;
              ...
              slider.style.height =
                sliderWrapper.children[0].offsetHeight + "px";
              updateSliderLayout();
